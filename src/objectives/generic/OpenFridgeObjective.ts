...
export class OpenFridgeObjective extends AObjective {
    ...
    protected onInit(): void {
        ...
        this.fridge_door = new AInteractable(
            'fridge_door',
            () => {
                new Sound('sound/open_fridge.wav', false);

                new Animation(
                    {
                        'dur': '1000', 'attribute': 'rotation', 'to': new Vec3(0, 0, 0)
                    },
                    this.fridge_door,
                    () => {
